      ...
      <div className="mx-auto max-w-[640px]">
        ...
        <div className="mb-4 rounded-2xl border border-[#E4E2DA] bg-background p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          <div className="mb-5 flex items-center gap-2.5">
            <div className="flex h-[30px] w-[30px] items-center justify-center rounded-lg bg-gold/25">
        ...
        {/* Result card */}
        <div className="mb-4 rounded-2xl bg-navy p-7 shadow-elevated">
          ...
          <div className="mb-6 flex items-end gap-1.5">
            <span className="text-[56px] font-semibold leading-none tracking-tight text-gold max-[480px]:text-[44px]">{fmt(result.totalFinal)}</span>
          ...
          <div className="flex flex-wrap items-center justify-between gap-2.5">
            ...
            <button onClick={downloadSummary} className="inline-flex items-center gap-1.5 rounded-full bg-gold px-3.5 py-1.5 text-xs font-semibold text-gold-foreground transition-colors hover:bg-gold/90">
        ...
        <div className="mb-4 rounded-2xl border border-[#E4E2DA] bg-background p-5 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          <div className="mb-4 text-[11px] font-semibold uppercase tracking-[0.08em] text-teal">How this is calculated</div>
