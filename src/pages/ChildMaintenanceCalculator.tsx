...
<style>body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:600px;margin:40px auto;padding:0 20px;color:#1a1a1a;font-size:14px}
.header{border-bottom:2px solid #1D9E75;padding-bottom:16px;margin-bottom:24px}
h1{font-size:20px;font-weight:700;margin-bottom:4px}.date{font-size:12px;color:#9ca3af}
.result-box{background:#0f6e56;border-radius:12px;padding:20px;margin:20px 0;color:#fff}
.result-box .amount{font-size:40px;font-weight:700;margin-bottom:12px}
table{width:100%;border-collapse:collapse;font-size:13px}td,th{padding:8px 10px;text-align:left;border-bottom:1px solid #f3f4f6}
th{background:#f9fafb;font-weight:600;font-size:12px;color:#6b7280;text-transform:uppercase}
.footer{margin-top:32px;padding-top:16px;border-top:1px solid #e5e7eb;font-size:11px;color:#9ca3af;line-height:1.6}
</style></head><body>
...
<h2 style="font-size:12px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin-bottom:10px">Income details</h2>
...
<h2 style="font-size:12px;font-weight:700;color:#9ca3af;text-transform:uppercase;margin:20px 0 10px">Shared care breakdown</h2>
...
<div class="footer"><strong>Please note:</strong> This is a general estimate based on the standard CMS formula. This document is not financial or legal advice.<br><br>Generated by Collabor8 - collaborate8.com</div>
  ...
  const selectClass = "w-full rounded-[10px] border-[1.5px] border-[#e5e7eb] bg-white px-3 py-2.5 pr-8 text-sm text-[#1a1a1a] transition-colors focus:border-[#1D9E75] focus:outline-none focus:ring-[3px] focus:ring-[#1D9E75]/10";
  const inputClass = "w-full rounded-[10px] border-[1.5px] border-[#e5e7eb] bg-white px-3 py-2.5 text-sm text-[#1a1a1a] placeholder:text-[#d1d5db] transition-colors focus:border-[#1D9E75] focus:outline-none focus:ring-[3px] focus:ring-[#1D9E75]/10";
  ...
  return (
    <div className="min-h-screen bg-[#f0f2f5] px-4 py-10" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      <Helmet>
      ...
      <div className="mx-auto max-w-[640px]">
        ...
        <div className="mb-8">
          <div className="mb-5 flex items-center gap-2">
            ...
            <span className="text-[15px] font-semibold tracking-tight text-[#1a1a1a]">Collabor8</span>
          </div>
          <h1 className="mb-1.5 text-[26px] font-semibold tracking-tight text-[#1a1a1a]">Child maintenance calculator</h1>
          <p className="text-sm leading-relaxed text-[#6b7280]">An estimate based on Child Maintenance Service (CMS) calculations. Enter your details below to see an indicative figure.</p>
        </div>

        {/* Paying parent card */}
        <div className="mb-4 rounded-2xl border border-[#e5e7eb] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          <div className="mb-5 flex items-center gap-2.5">
            <div className="flex h-[30px] w-[30px] items-center justify-center rounded-lg bg-[#e8f7f2]">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="5" r="2.5" stroke="#1D9E75" strokeWidth="1.5" /><path d="M2.5 14c0-2.761 2.462-4.5 5.5-4.5s5.5 1.739 5.5 4.5" stroke="#1D9E75" strokeWidth="1.5" strokeLinecap="round" /></svg>
            </div>
            <span className="text-[13px] font-semibold uppercase tracking-[0.06em] text-[#374151]">Parent making payments</span>
          </div>
          <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2">
            <div>
              <label className="mb-1 block text-sm font-medium text-[#374151]">{incomeLabels[incomePeriod].label}</label>
              <p className="mb-1.5 text-xs leading-snug text-[#9ca3af]">Before tax and National Insurance, after pension contributions</p>
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-[#374151]">Income period</label>
              <p className="mb-1.5 text-xs leading-snug text-[#9ca3af]">How your income figure is expressed</p>
          ...
          <div className="mt-3.5">
            <label className="mb-1 block text-sm font-medium text-[#374151]">Income type</label>
          ...
          <div className="mt-3.5 grid grid-cols-1 gap-3.5 sm:grid-cols-2">
            <div>
              <label className="mb-1 block text-sm font-medium text-[#374151]">Other children in household</label>
              <p className="mb-1.5 text-xs leading-snug text-[#9ca3af]">Children supported in your household</p>
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-[#374151]">Qualifying children</label>
              <p className="mb-1.5 text-xs leading-snug text-[#9ca3af]">Children this arrangement covers</p>
        ...
        <div className="mb-4 rounded-2xl border border-[#e5e7eb] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          <div className="mb-5 flex items-center gap-2.5">
            <div className="flex h-[30px] w-[30px] items-center justify-center rounded-lg bg-[#e8f0fb]">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="2" y="3" width="12" height="10" rx="2" stroke="#3b82f6" strokeWidth="1.5" /><path d="M5 3V2m6 1V2M2 7h12" stroke="#3b82f6" strokeWidth="1.5" strokeLinecap="round" /></svg>
            </div>
            <span className="text-[13px] font-semibold uppercase tracking-[0.06em] text-[#374151]">Shared care - overnight stays</span>
          </div>
          <p className="mb-3 text-xs leading-snug text-[#9ca3af]">Enter the number of nights per year each child spends with the parent making payments. The CMS adjusts the amount for each child individually based on this.</p>
          <div className="flex flex-col gap-2.5">
            {Array.from({ length: kidsNum }).map((_, i) => (
              <div key={i} className="grid grid-cols-[100px_1fr] items-center gap-3 max-[480px]:grid-cols-[80px_1fr]">
                <span className="text-[13px] font-medium text-[#374151]">{ordinal(i + 1)} child</span>
        ...
        {/* Result card */}
        <div className="mb-4 rounded-2xl bg-[#0f6e56] p-7">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2.5">
            ...
            <button onClick={downloadSummary} className="inline-flex items-center gap-1.5 rounded-full bg-white/95 px-3.5 py-1.5 text-xs font-semibold text-[#0f6e56] transition-colors hover:bg-white">
        ...
        {/* Breakdown card */}
        <div className="mb-4 rounded-2xl border border-[#e5e7eb] bg-white p-5 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          <div className="mb-4 text-[11px] font-semibold uppercase tracking-[0.08em] text-[#9ca3af]">How this is calculated</div>
          <div className="flex items-center justify-between border-b border-[#f3f4f6] py-2">
            <span className="text-[13px] text-[#6b7280]">Gross weekly income</span>
            <span className="text-[13px] font-medium text-[#1a1a1a]">{fmtW(result.weeklyGross)}</span>
          </div>
          {result.otherKidsNum > 0 && (
            <div className="flex items-center justify-between border-b border-[#f3f4f6] py-2">
              <span className="text-[13px] text-[#6b7280]">Adjusted for other children</span>
              <span className="text-[13px] font-medium text-[#1a1a1a]">{fmtW(result.adjIncome)} (−{Math.round(result.deductionRate * 100)}%)</span>
            </div>
          )}
          <div className="flex items-center justify-between border-b border-[#f3f4f6] py-2">
            <span className="text-[13px] text-[#6b7280]">Rate applied</span>
            <span className="text-[13px] font-medium text-[#1a1a1a]">{result.rateDesc}</span>
          </div>
          <div className="flex items-center justify-between border-b border-[#f3f4f6] py-2">
            <span className="text-[13px] text-[#6b7280]">Base amount (before shared care)</span>
            <span className="text-[13px] font-medium text-[#1a1a1a]">{fmtW(result.baseWeekly)}</span>
          </div>
          ...
          {kidsNum > 1 && result.childResults.map((c, i) => {
            ...
            if (c.pct > 0) adjText = "−" + Math.round(c.pct * 100) + "%" + (c.extra > 0 ? " and −£7/wk" : "");
            return (
              <div key={i} className="my-1.5 rounded-[10px] border border-[#f3f4f6] bg-[#f9fafb] p-3">
                <div className="mb-1.5 text-xs font-semibold uppercase tracking-[0.06em] text-[#9ca3af]">{ordinal(i + 1)} child</div>
                <div className="flex justify-between py-0.5 text-xs text-[#6b7280]"><span>Overnight stays</span><span className="font-medium text-[#374151]">{nightOpt.label}</span></div>
                <div className="flex justify-between py-0.5 text-xs text-[#6b7280]"><span>Base amount</span><span className="font-medium text-[#374151]">{fmtW(c.base)}</span></div>
                <div className="flex justify-between py-0.5 text-xs text-[#6b7280]"><span>Shared care adjustment</span><span className="font-medium text-[#374151]">{adjText}</span></div>
                <div className="flex justify-between py-0.5 text-xs text-[#6b7280]"><span>Child estimate</span><span className="font-medium text-[#374151]">{fmtW(c.final)}</span></div>
              </div>
            );
          })}

          <div className="mt-2 flex items-center justify-between border-t border-[#f3f4f6] pt-2.5">
            <span className="text-sm font-semibold text-[#1a1a1a]">Weekly estimate</span>
            <span className="text-sm font-semibold text-[#1D9E75]">{fmtW(result.totalFinal)}</span>
          </div>
        </div>

        {/* Notice */}
        <div className="mb-6 rounded-xl border border-[#e5e7eb] bg-white p-4 shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
          <div className="flex gap-2.5">
            <Info className="mt-0.5 h-[18px] w-[18px] flex-shrink-0 text-[#9ca3af]" />
            <p className="text-xs leading-relaxed text-[#9ca3af]">
              <strong className="font-medium text-[#6b7280]">Please note:</strong> This calculator provides a general estimate based on the standard CMS formula. Every family's circumstances are different, and factors such as pension contributions, rental income, overseas income and other variables may affect the actual figure. This tool is intended to help you understand how child maintenance is typically calculated - it is not financial or legal advice. We recommend speaking with a qualified adviser for guidance specific to your situation.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6 text-sm leading-relaxed text-[#6b7280]">
          <section>
            <h2 className="mb-2 text-lg font-semibold text-[#1a1a1a]">How is child maintenance calculated in the UK?</h2>
            <p>
              ...
              <a href="https://www.gov.uk/calculate-child-maintenance" target="_blank" rel="noopener noreferrer" className="underline hover:text-[#1a1a1a]">gov.uk/calculate-child-maintenance</a> or contact the Child Maintenance Service directly.
            </p>
          </section>
          <section>
            <h2 className="mb-2 text-lg font-semibold text-[#1a1a1a]">Understanding the CMS rates</h2>
            <ul className="ml-5 list-disc space-y-1">
              <li><strong className="text-[#1a1a1a]">Nil rate</strong> - Income below £7 per week. No maintenance payable.</li>
              <li><strong className="text-[#1a1a1a]">Flat rate</strong> - Income between £7 and £100/week, or on qualifying benefits. Fixed at £7/week.</li>
              <li><strong className="text-[#1a1a1a]">Reduced rate</strong> - Income between £100 and £200/week. A graduated formula applies.</li>
              <li><strong className="text-[#1a1a1a]">Basic rate</strong> - Income above £200/week. 12% for 1 child, 16% for 2, 19% for 3+.</li>
            </ul>
          </section>
          <section>
            <h2 className="mb-2 text-lg font-semibold text-[#1a1a1a]">Related resources</h2>
            <ul className="ml-5 list-disc space-y-1">
              <li><Link to="/resources/child-maintenance-guide" className="underline hover:text-[#1a1a1a]">Child Maintenance Made Simple - Full Guide</Link></li>
              <li><Link to="/resources/financial-coparenting-tips" className="underline hover:text-[#1a1a1a]">Financial Co-parenting Tips</Link></li>
            </ul>
          </section>
        </div>
      </div>
