    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-background" style={{ fontFamily: "'Figtree', sans-serif" }}>
      ...
      <div className="relative overflow-hidden bg-foreground px-[5vw] pb-16 pt-20">
        ...
        <div className="relative z-10 max-w-[760px]">
          ...
          <h1 className="mb-5 text-[clamp(2.4rem,5vw,3.6rem)] font-light leading-[1.1] tracking-tight text-white" style={{ fontFamily: "'Fraunces', serif" }}>
            Your privacy,<br /><em className="italic text-[#1A1A18]">taken seriously.</em>
          </h1>
      ...
      <div className="mx-auto grid max-w-[1100px] gap-16 px-[5vw] pb-24 pt-12 md:grid-cols-[220px_1fr]">
        ...
        <aside className="md:sticky md:top-[90px] md:self-start">
          <div className="mb-4 border-b border-[#E4E2DA] pb-3 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#6B6B64]">Contents</div>
        ...
        <main className="min-w-0">
          ...
          <section ref={setRef("s1")} id="s1" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">01</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>Who we are</h2>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">Collaborate Technologies Ltd is the data controller for all personal data processed through the Service.</p>
          ...
          <section ref={setRef("s2")} id="s2" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">02</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>What personal data we collect</h2>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">We collect only the data necessary to provide the Service.</p>

            <h3 className="mb-2.5 mt-6 text-[0.95rem] font-semibold text-[#1A1A18]">Data you give us directly</h3>
            ...
            <h3 className="mb-2.5 mt-6 text-[0.95rem] font-semibold text-[#1A1A18]">Data we collect automatically</h3>
            <ul className="mb-4 flex flex-col gap-2">
              {[
            ...
            <h3 className="mb-2.5 mt-6 text-[0.95rem] font-semibold text-[#1A1A18]">Data from third parties</h3>
            <ul className="mb-4 flex flex-col gap-2">
              {[
          ...
          <section ref={setRef("s3")} id="s3" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">03</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>How and why we use your data</h2>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">The table below sets out every purpose for which we process personal data and the lawful basis under UK GDPR Article 6 that we rely on.</p>
            ...
            <p className="mt-2 text-[0.85rem] text-[#6B6B64]">We do not use your personal data for automated decision-making or profiling that produces legal or similarly significant effects.</p>
          </section>

          {/* 4. Who we share with */}
          <section ref={setRef("s4")} id="s4" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">04</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>Who we share your data with</h2>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">We do not sell your personal data. We share it only as set out below.</p>

            <h3 className="mb-2.5 mt-6 text-[0.95rem] font-semibold text-[#1A1A18]">Service providers (processors)</h3>
            <ul className="mb-4 flex flex-col gap-2">
              {[
            ...
            <h3 className="mb-2.5 mt-6 text-[0.95rem] font-semibold text-[#1A1A18]">Co-parent sharing - what is and is not shared</h3>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">Collabor8 allows two parents to work within a shared workspace. It is important to understand exactly what each party can and cannot see:</p>
            <ul className="mb-4 flex flex-col gap-2">
              {[
            ...
            <h3 className="mb-2.5 mt-6 text-[0.95rem] font-semibold text-[#1A1A18]">Legal and regulatory disclosure</h3>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">We may disclose data where required by law, court order or regulatory authority, or where necessary to protect the rights, property or safety of Collabor8, our users or others.</p>

            <h3 className="mb-2.5 mt-6 text-[0.95rem] font-semibold text-[#1A1A18]">Business transfers</h3>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">If Collaborate Technologies Ltd is involved in a merger, acquisition or asset sale, personal data may be transferred. We will notify you by email before any such transfer occurs and before data becomes subject to a different privacy policy.</p>
          </section>

          {/* 5. International transfers */}
          <section ref={setRef("s5")} id="s5" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">05</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>International data transfers</h2>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">Our primary infrastructure is located in the UK and EU (AWS eu-west-2). Some third-party processors are based in the United States. Where we transfer data outside the UK, we ensure appropriate safeguards are in place, including:</p>
            <ul className="mb-4 flex flex-col gap-2">
              {[
            ...
            <p className="text-[0.95rem] leading-[1.75] text-[#3D3D38]">You may request a copy of the relevant transfer mechanism by contacting <a href="mailto:privacy@collaborate8.com" className="text-[#1A1A18] hover:underline">privacy@collaborate8.com</a>.</p>
          </section>

          {/* 6. Retention */}
          <section ref={setRef("s6")} id="s6" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">06</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>How long we keep your data</h2>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-[0.86rem]">
                <thead>
                  <tr className="bg-foreground">
            ...
            <p className="mt-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">After applicable retention periods, data is securely deleted or anonymised so it can no longer be linked to you.</p>
          </section>

          {/* 7. Security */}
          <section ref={setRef("s7")} id="s7" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">07</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>Security</h2>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">We implement appropriate technical and organisational measures to protect your personal data. These include:</p>
            <ul className="mb-4 flex flex-col gap-2">
              {[
            ...
            <p className="text-[0.95rem] leading-[1.75] text-[#3D3D38]">If you discover a vulnerability, please report it responsibly to <a href="mailto:security@collaborate8.com" className="text-[#1A1A18] hover:underline">security@collaborate8.com</a>.</p>
          </section>

          {/* 8. Your rights */}
          <section ref={setRef("s8")} id="s8" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">08</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>Your rights under UK GDPR</h2>
            <p className="mb-4 text-[0.95rem] leading-[1.75] text-[#3D3D38]">You have the following rights in relation to your personal data. Contact us at <a href="mailto:privacy@collaborate8.com" className="text-[#1A1A18] hover:underline">privacy@collaborate8.com</a> to exercise any of them. We will respond within one calendar month.</p>
            ...
            <div className="mt-6 rounded-xl border border-[#E4D8C6] border-l-[3px] border-l-[#1A1A18] bg-secondary p-4">
              ...
              <p className="text-[0.88rem] leading-relaxed text-[#3D3D38]">
                ...
                <a href="https://ico.org.uk" target="_blank" rel="noopener" className="text-[#1A1A18] hover:underline">ico.org.uk</a>{" "}
          ...
          <section ref={setRef("s9")} id="s9" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">09</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>Cookies & tracking technologies</h2>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">We use cookies and similar technologies on collaborate8.com. You can manage your preferences via the cookie banner on your first visit or at any time in your account settings.</p>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-[0.86rem]">
                <thead>
                  <tr className="bg-foreground">
          ...
          <section ref={setRef("s10")} id="s10" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">10</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>Third-party links</h2>
            <p className="text-[0.95rem] leading-[1.75] text-[#3D3D38]">The Service may contain links to third-party websites. We are not responsible for the privacy practices of those sites and encourage you to read their privacy policies before providing any personal data.</p>
          </section>

          {/* 11. Changes */}
          <section ref={setRef("s11")} id="s11" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">11</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>Changes to this policy</h2>
            <p className="mb-3 text-[0.95rem] leading-[1.75] text-[#3D3D38]">We may update this Privacy Policy from time to time. When we make material changes we will:</p>
            <ul className="mb-4 flex flex-col gap-2">
              {[
            ...
            <p className="text-[0.95rem] leading-[1.75] text-[#3D3D38]">Your continued use of the Service after the effective date constitutes acceptance of the updated policy.</p>
          </section>

          {/* 12. Contact us */}
          <section ref={setRef("s12")} id="s12" className="mb-14 scroll-mt-[90px]">
            <div className="mb-2 text-[0.72rem] font-bold uppercase tracking-[0.1em] text-[#1A1A18]">12</div>
            <h2 className="mb-5 border-b border-[#E4E2DA] pb-3 text-[1.65rem] font-normal leading-tight text-[#1A1A18]" style={{ fontFamily: "'Fraunces', serif" }}>Contact us</h2>
            ...
            <div className="mt-6 rounded-xl border border-[#E4D8C6] border-l-[3px] border-l-[#1A1A18] bg-secondary p-4">
              ...
              <p className="text-[0.88rem] leading-relaxed text-[#3D3D38]">
                ...
                <a href="https://ico.org.uk/about-the-ico/what-we-do/register-of-fee-payers/" target="_blank" rel="noopener" className="text-[#1A1A18] hover:underline">ico.org.uk/register-of-fee-payers</a>.
              </p>
            </div>
          </section>
        </main>
