...
const ArticleNav = ({ prev, next }: ArticleNavProps) => (
  <nav className="mt-14 flex flex-wrap justify-between gap-4 border-t border-[#E4E2DA] pt-8" aria-label="Article navigation">
    {prev && (
      <Link to={prev.to} className="flex min-w-[200px] flex-1 flex-col gap-1 rounded-lg border border-[#E4E2DA] bg-white p-4 no-underline transition-all hover:border-[#1E6B5E] hover:shadow-[0_4px_16px_rgba(30,107,94,0.08)]">
    ...
    {next && (
      <Link to={next.to} className="flex min-w-[200px] flex-1 flex-col items-end gap-1 rounded-lg border border-[#E4E2DA] bg-white p-4 text-right no-underline transition-all hover:border-[#1E6B5E] hover:shadow-[0_4px_16px_rgba(30,107,94,0.08)]">
